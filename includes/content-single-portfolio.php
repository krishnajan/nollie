...
$translate['project-description'] = mfn_opts_get('translate') ? mfn_opts_get('translate-project-description','Project Description:') : __('Project Description:','nollie');
$translate['client'] = mfn_opts_get('translate') ? mfn_opts_get('translate-client','Client:') : __('Client:','nollie');
$translate['date'] = mfn_opts_get('translate') ? mfn_opts_get('translate-date','Date:') : __('Date:','nollie');
$translate['category'] = mfn_opts_get('translate') ? mfn_opts_get('translate-category','Category:') : __('Category:','nollie');
$translate['project-url'] = mfn_opts_get('translate') ? mfn_opts_get('translate-project-url','Project URL:') : __('Project URL:','nollie');
$translate['visit-online'] = mfn_opts_get('translate') ? mfn_opts_get('translate-visit-online','Visit online &rarr;') : __('Visit online &rarr;','nollie');
$translate['back'] = mfn_opts_get('translate') ? mfn_opts_get('translate-back','Back to list') : __('Back to list','nollie');
?>

<div class="single-portfolio" id="portfolio-item-<?php the_ID(); ?>" >							
	
	<?php
		if( $video = get_post_meta($post->ID, 'mfn-post-vimeo', true) ):
	...
	<div class="desc">
		...
		<div class="sp-inside">
			...
			<div class="sp-inside-right">
				...
				?>
					<footer>
						<a class="button button_small" href="<?php echo get_page_link( $portfolio_page_id ); ?>"><span><?php echo $translate['back']; ?></span></a>
					</footer>
				<?php endif; ?>
