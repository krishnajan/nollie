	...
	class MFN_Options{
		...
		*/
		function __construct( $menu = array(), $sections = array() ){
			...
			$defaults['opt_name'] = 'nollie';
			
			$defaults['menu_icon'] = MFN_OPTIONS_URI.'/img/menu_icon.png';
			$defaults['menu_title'] = __('Nollie Theme Options', 'mfn-opts');
			$defaults['page_icon'] = 'icon-themes';
			$defaults['page_title'] = __('Nollie Theme Options', 'mfn-opts');
								...
								echo '<div class="mfn-import-wrapper">';
									...
									echo '<div class="mfn-import-box mfn-import-exp">';
										...
										echo '<p>';
											...
											echo '<a href="'.add_query_arg(array('feed' => 'mfn-opts-'.$this->args['opt_name'], 'action' => 'download_options', 'secret' => md5(AUTH_KEY.SECURE_AUTH_KEY)), site_url()).'" class="button-primary mfn-import-exp-download-btn">'.__('Download', 'mfn-opts').'</a>&nbsp;';
