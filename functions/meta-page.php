...
$mfn_page_meta_box = array(
	...
	'fields' => array(
		...
		array(
			'id' => 'mfn-post-content',
			'type' => 'switch',
			'title' => __('Show the content', 'mfn-opts'), 
			'sub_desc' => __('Show the content from the WordPress editor.', 'mfn-opts'),
			'desc' => __('Turn it off if you build content using Content Builder. (Use the Content item if you want to display the Content from editor within the Content Builder).', 'mfn-opts'),
