...
function mfn_builder_show() {
	...
	$mfn_std_items = array(
		...
		'article_box' => array(
			...
			'fields' => array(
				...
				array(
					...
					'desc' => __('Recommended size 85px x 125px.', 'mfn-opts'),
				),
		...
		'clients' => array(
			...
			'fields' => array(
				...
				array(
					...
					'type' => 'select',
					'title' => __('Link', 'mfn-opts'),
					'options' => array( 'client' => 'Client\'s site link', 'page' => 'Page from below list' ),
				),
				
				array(
					'id' => 'page',
					'type' => 'pages_select',
					'title' => __('Client\'s page', 'mfn-opts'),
					'desc' => __('This option can be used only with above option set to "page".', 'mfn-opts'),
					'args' => array()
				),
		...
		'feature_box' => array(
			...
			'fields' => array(
				...
				array(
					...
					'sub_desc' => __('Type icon name (eg. icon-cogs)', 'mfn-opts'),
					'desc' => __('Select icon name from the list of available <a href="http://fortawesome.github.com/Font-Awesome" target="_blank">Font Awesome icons</a> or upload image in the below field.', 'mfn-opts'),
				),
				...
				array(
					...
					'type' => 'upload',
					'title' => __('Image', 'mfn-opts'),
					'sub_desc' => __('Custom icon image.', 'mfn-opts'),
					'desc' => __('Recommended size: 70px x 70px.', 'mfn-opts'),
				),
		...
		'offer' => array(
			...
			'fields' => array(
				...
				array(
					...
					'type' => 'text',
					'title' => __('Title', 'mfn-opts'),
					'std' => __('What we <span>offer</span>', 'mfn-opts'),
					'desc' => __('Wrap text into "span" tag to highlight it.', 'mfn-opts'),
				),
				...
				array(
					...
					'type' => 'upload',
					'title' => __('Image', 'mfn-opts'),
					'desc' => __('Recommended size: 300px x 280px.', 'mfn-opts'),
				),
				
				array(
					'id' => 'item1_title',
					'type' => 'text',
					'title' => __('Item 1 Title', 'mfn-opts'),
					'desc' => __('Left top.', 'mfn-opts'),
					'class' => 'small-text',
				),
				...
				array(
					'id' => 'item1_text',
					'type' => 'text',
					'title' => __('Item 1 Text', 'mfn-opts'),
				),
				
				array(
					'id' => 'item1_image',
					'type' => 'upload',
					'title' => __('Item 1 Image', 'mfn-opts'),
					'desc' => __('Recommended size: 24px x 24px.', 'mfn-opts'),
				),
				
				array(
					'id' => 'item2_title',
					'type' => 'text',
					'title' => __('Item 2 Title', 'mfn-opts'),
					'desc' => __('Left middle.', 'mfn-opts'),
					'class' => 'small-text',
				),
				...
				array(
					'id' => 'item2_text',
					'type' => 'text',
					'title' => __('Item 2 Text', 'mfn-opts'),
				),
				
				array(
					'id' => 'item2_image',
					'type' => 'upload',
					'title' => __('Item 2 Image', 'mfn-opts'),
					'desc' => __('Recommended size: 24px x 24px.', 'mfn-opts'),
				),
				...
				array(
					'id' => 'item3_title',
					'type' => 'text',
					'title' => __('Item 3 Title', 'mfn-opts'),
					'desc' => __('Left bottom.', 'mfn-opts'),
					'class' => 'small-text',
				),
				...
				array(
					'id' => 'item3_text',
					'type' => 'text',
					'title' => __('Item 3 Text', 'mfn-opts'),
				),
				
				array(
					'id' => 'item3_image',
					'type' => 'upload',
					'title' => __('Item 3 Image', 'mfn-opts'),
					'desc' => __('Recommended size: 24px x 24px.', 'mfn-opts'),
				),
				...
				array(
					'id' => 'item4_title',
					'type' => 'text',
					'title' => __('Item 4 Title', 'mfn-opts'),
					'desc' => __('Right top.', 'mfn-opts'),
					'class' => 'small-text',
				),
				...
				array(
					'id' => 'item4_text',
					'type' => 'text',
					'title' => __('Item 4 Text', 'mfn-opts'),
				),
				
				array(
					'id' => 'item4_image',
					'type' => 'upload',
					'title' => __('Item 4 Image', 'mfn-opts'),
					'desc' => __('Recommended size: 24px x 24px.', 'mfn-opts'),
				),
				...
				array(
					'id' => 'item5_title',
					'type' => 'text',
					'title' => __('Item 5 Title', 'mfn-opts'),
					'desc' => __('Right middle.', 'mfn-opts'),
					'class' => 'small-text',
				),
				...
				array(
					'id' => 'item5_text',
					'type' => 'text',
					'title' => __('Item 5 Text', 'mfn-opts'),
				),
				
				array(
					'id' => 'item5_image',
					'type' => 'upload',
					'title' => __('Item 5 Image', 'mfn-opts'),
					'desc' => __('Recommended size: 24px x 24px.', 'mfn-opts'),
				),
				...
				array(
					'id' => 'item6_title',
					'type' => 'text',
					'title' => __('Item 6 Title', 'mfn-opts'),
					'desc' => __('Right bottom.', 'mfn-opts'),
					'class' => 'small-text',
				),
				...
				array(
					'id' => 'item6_text',
					'type' => 'text',
					'title' => __('Item 6 Text', 'mfn-opts'),
				),
				
				array(
					'id' => 'item6_image',
					'type' => 'upload',
					'title' => __('Item 6 Image', 'mfn-opts'),
					'desc' => __('Recommended size: 24px x 24px.', 'mfn-opts'),
				),
				...
				array(
					'id' => 'btn1_title',
					'type' => 'text',
					'title' => __('Button 1 Title', 'mfn-opts'),
					'desc' => __('Left button.', 'mfn-opts'),
					'std' => __('See our offer', 'mfn-opts'),
					'class' => 'small-text',
				),
				...
				array(
					'id' => 'btn1_link',
					'type' => 'text',
					'title' => __('Button 1 Link', 'mfn-opts'),
				),
				
				array(
					'id' => 'btn2_title',
					'type' => 'text',
					'title' => __('Button 2 Title', 'mfn-opts'),
					'desc' => __('Right button.', 'mfn-opts'),
					'std' => __('Contact form', 'mfn-opts'),
					'class' => 'small-text',
				),
				...
				array(
					'id' => 'btn2_link',
					'type' => 'text',
					'title' => __('Button 2 Link', 'mfn-opts'),
				),
		...
		'our_team' => array(
			...
			'fields' => array(
				...
				array(
					...
					'desc' => __('Recommended size: 820px × 738px.', 'mfn-opts'),
				),
		...
		'recent_comments' => array(
			...
			'title' => __('Recent Comments', 'mfn-opts'), 
			'size' => '1/4',
			'fields' => array(
				...
				array(
					'id' => 'count',
					'type' => 'text',
					'title' => __('Number of comments', 'mfn-opts'),
					'class' => 'small-text',
					'sub_desc' => __('Number of comments to show', 'mfn-opts'), 
				),
...
function mfn_print_latest_posts( $item ) {
	if( ! key_exists('content', $item['fields']) ) $item['fields']['content'] = '';
	echo sc_latest_posts( $item['fields'], $item['fields']['content'] );	
}
...
function mfn_print_portfolio( $item ) {
	...
	if( ! key_exists('content', $item['fields']) ) $item['fields']['content'] = '';
	echo sc_portfolio( $item['fields'], $item['fields']['content'] );
}
...
function mfn_print_recent_comments( $item ) {
	if( ! key_exists('content', $item['fields']) ) $item['fields']['content'] = '';
	echo sc_recent_comments( $item['fields'], $item['fields']['content'] );	
}
...
function mfn_print_testimonial( $item ) {
